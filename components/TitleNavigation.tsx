...
function TitleNavigation() {
  return (
    <div className="h-auto paddings absolute top-[20%]  left-0 right-0 ml-auto mr-auto flex items-center justify-center ">
      <div className="flex flex-col items-center justify-center flex-wrap ">
        <div className="  font-semibold text-center md:top-24 top-[16%]">
